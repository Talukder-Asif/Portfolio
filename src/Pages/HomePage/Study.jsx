    ...
    <div id="Education" className="max-w-7xl py-10 m-auto">
      <div className="text-center">
        ...
        <p className="py-6 font1 m-auto max-w-[95%] md:max-w-[70%] lg:max-w-[60%] font-medium">
          My education has been a catalyst for exploring the endless
          possibilities within the realm of computer science, instilling in me a
          passion for continuous learning and a drive to contribute to the
